...
public class Ut implements OpenStreetMapConstants, OpenStreetMapViewConstants {
    ...
    public static String getAppVersion(Context ctx) {
        ...
        String res = "";
        try {
            pi = ctx.getPackageManager().getPackageInfo("com.hariff.bms.kavaleri", 0);
            res = pi.versionName;
    ...
    private static String SIGNAL_FILE_NAME = "/BMSOnSDCard";
    ...
    public static String getUsbStorageDirectory() {
        return DATA_FROM_POSKO;
    }

    public static File getBMSFromPosko(final Context mCtx) {
        return getDir(mCtx, "pref_dir_ops", Ut.getUsbStorageDirectory(), "");
    }
    ...
    public static File getBMSMapsDir(final Context mCtx) {
        return getDir(mCtx, "pref_dir_maps", getBMSMainDir(mCtx, "maps").getAbsolutePath(), "");
    }

    public static File getBMSImportDir(final Context mCtx) {
        return getDir(mCtx, "pref_dir_import", getBMSMainDir(mCtx, "import").getAbsolutePath(), "");
    }

    public static File getBMSExportDir(final Context mCtx) {
        return getDir(mCtx, "pref_dir_export", getBMSMainDir(mCtx, "export").getAbsolutePath(), "");
    }

    public static File getBMSCacheTilesDir(final Context mCtx) {
        return getBMSMainDir(mCtx, "cache/tiles");
    }
    ...
    public static String formatGeoPoint4Digit(GeoPoint point){
        return point.toDoubleString4Digit();
    }
...
//	        }
    ...
    public static CharSequence formatDms(String dms) {
        DecimalFormat df = new DecimalFormat("0.000#");
        double sec;
        StringBuilder sb = new StringBuilder();
        TextUtils.SimpleStringSplitter splitter = new TextUtils.SimpleStringSplitter(':');
        splitter.setString(dms);
        sb.append(splitter.next());
        sb.append((char) 0x00B0);
        sb.append(splitter.next());
        sb.append((char) 0x2032);
        sec = Double.parseDouble(splitter.next());
        sb.append(df.format(sec));
        sb.append((char) 0x2033);

        return sb.toString();
    }

    public static CharSequence locGetDeg(String dms) {
        TextUtils.SimpleStringSplitter splitter = new TextUtils.SimpleStringSplitter(':');
        splitter.setString(dms);
    ...
    public static CharSequence locGetMin(String dms) {
        TextUtils.SimpleStringSplitter splitter = new TextUtils.SimpleStringSplitter(':');
        splitter.setString(dms);
        splitter.next();
        return splitter.next();
    ...
    public static CharSequence locGetSec(String dms) {
        TextUtils.SimpleStringSplitter splitter = new TextUtils.SimpleStringSplitter(':');
        splitter.setString(dms);
        splitter.next();
        splitter.next();
