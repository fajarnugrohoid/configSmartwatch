...
public class TileProviderBase {
    ...
    public TileProviderBase(Context ctx) {
        super();
        //mLoadingMapTile = BitmapFactory.decodeResource(ctx.getResources(), R.drawable.loading_white);
        mLoadingMapTile = BitmapFactory.decodeResource(ctx.getResources(), R.drawable.card_background);
    }
