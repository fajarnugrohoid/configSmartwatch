...
public class NeighbourModelMessage {
    ...
    public NeighbourModelMessage(int id, String portName, String addrId, int FriendId, Double Lat, Double Long, String message) {
