...
import parser.NeighbourDataParser;
...
public class NeighbourService extends Service {
    private static final String LOG_TAG = "smartwatch-neighbour";
    public static final String CUSTOM_INTENT = "MainActivity";
    Context context;
    public static final int serverPort = 9004;
    ...
    public void onCreate() {
        ...
        Log.i("xxx", "onCreate LocalService");
    ...
    public int onStartCommand(Intent i, int flags, int startId){
        ...
        Log.d(LOG_TAG, "NeighbourService started.");
    ...
    public class ReadThread implements Runnable {
        ...
        NeighbourDataParser dataParser = new NeighbourDataParser();
                ...
                try {
                    ...
                    if (isnttimeout) {
                        ...
                        if (MainActivity.driverView==true){
                            ...
                            Log.d(LOG_TAG, "sb neighbour:" + sb.toString());
                            sb.delete(0, sb.length());
                            Log.i(LOG_TAG, "buffer:" + buffer);
                            packetString = dataParser.parseSbcSentence(buffer);
                            Log.i(LOG_TAG, "packetString ccu neighbour : " + packetString);
        ...
        private void produce(String msg) {
            ...
            if (arrPortName.length > 1){
                ...
                if (arrParsed.length > 2){
                    ...
                    if (arrPortName[0].equalsIgnoreCase("neighbour")){
    ...
    {
        Log.i(TAG, "dataService :" + event.getMessageQueue());
    }
